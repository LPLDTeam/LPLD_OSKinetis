...
#define NRF24L01_CE_H    LPLD_GPIO_Output_b(NRF24L01_CE_PTX,NRF24L01_CE_PIN,OUTPUT_H) 
#define NRF24L01_CE_L    LPLD_GPIO_Output_b(NRF24L01_CE_PTX,NRF24L01_CE_PIN,OUTPUT_L) 
