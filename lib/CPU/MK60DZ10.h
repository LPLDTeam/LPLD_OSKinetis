...
**     - rev. 1.2.1 (2013-06-18) 拉普兰德修改 www.lpld.cn
**         添加HardFault_IRQn中断向量号.
**
** ###################################################################
*/
 ...
 * @date 2011-09-08
 * @brief 为MK60DZ10提供基于CMSIS规范的外设接入层
 *
 * 更改建议:禁止修改
 *
 * 本文件定义MK60DZ10的位带操作、中断向量号，寄存器结构及地址等
 */
